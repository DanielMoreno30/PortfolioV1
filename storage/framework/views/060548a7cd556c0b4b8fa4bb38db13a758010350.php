...
<div class="modal fade" id="videointeractivo" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel"> <?php echo e(trans('multi-leng.botonvideointeractivo')); ?></h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
            <video id="medio" width="720" height="400">
                <source src="<?php echo e(asset('videos/itsmyturn.mp4')); ?>" type="video/mp4">
            </video>
  ...
  <script src="<?php echo e(asset('js/video.js')); ?>"></script><?php /**PATH C:\xampp\htdocs\PortfolioV1\resources\views/plantillas/video.blade.php ENDPATH**/ ?>